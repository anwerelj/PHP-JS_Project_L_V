...
<head>
    ...
    <title>Contact — AutoLoc Tunisie</title>
...
<body>
    ...
    <div class="form-container" style="max-width:600px;">
        ...
        <?php if($success) { ?>
            <div class="alert alert-success">✅ Message envoyé ! Nous vous répondrons bientôt.</div>
        <?php } ?>
        ...
        <p style="text-align:center;margin-top:1rem;color:#64748b;">
            📞 <a href="tel:+21650192517" style="color:#14b8a6;">+216 50 192 517</a>
            &nbsp;|&nbsp;
            ✉️ <a href="mailto:contact@autoloc.tn" style="color:#14b8a6;">contact@autoloc.tn</a>
        </p>
        <?php } ?>
    </div>
